...
int	main(void)
{
	...
	run_test("ft_putchar_fd", ft_putchar_fd_test);
	run_test("ft_putstr_fd", ft_putstr_fd_test);
	run_test("ft_putendl_fd", ft_putendl_fd_test);
	...
	run_test("ft_lstdelone", ft_lstdelone_test);
	run_test("ft_lstclear", ft_lstclear_test);
	printf("\n\n");
	return (0);
}
